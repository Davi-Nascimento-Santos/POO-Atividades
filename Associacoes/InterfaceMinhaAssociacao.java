...
public interface InterfaceMinhaAssociacao {

    // Calcula a frequência de um associado nas reuniões ocorridas durante
    //um determinado período, retornando um número entre 0 e 1 
    ...
    // Calcula o total de pagamentos realizado por um associado, 
    // em uma associação, para uma taxa, que possui uma vigência, 
    ...
    // Valida todos os campos para evitar dados não preenchidos.
