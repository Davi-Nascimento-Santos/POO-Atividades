...
public interface InterfaceAssociacao {
    ...
    // O valor a ser pago não pode ser menor que uma parcela,
    // embora não precise ser exatamente duas parcelas.
    // Uma parcela de R$20,00 por mês aceita um pagamento de R$30,00,
    // sendo uma parcela completa e um pedaço da próxima.
    // Associados remidos não deveriam mais realizar pagamentos de taxas
    // administrativas vigentes em datas antes da sua remissão, gerando
    // exceção de AssociadoJaRemido se houver tentativa de se pagar algo
    ...
    // Adiciona um associado a uma associação. Valida todos os campos para
    // evitar dados não preenchidos.
    ...
    // Adiciona uma taxa a uma associação. Valida todos os campos para
    // evitar dados não preenchidos.
