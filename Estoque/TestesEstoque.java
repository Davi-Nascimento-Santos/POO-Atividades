...
public class TestesEstoque {
	...
	public void produtosAbaixoDoEstoqueMinimo() {
		...
		assertTrue(produtosAbaixoDoMinimo[0].getCodigo() == produtos[0].getCodigo());
		assertTrue(produtosAbaixoDoMinimo[1].getCodigo() == produtos[1].getCodigo());
		assertTrue(produtosAbaixoDoMinimo.length == produtos.length);
