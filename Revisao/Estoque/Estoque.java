public class Estoque {
    ...
    public boolean incluir(Produto p){
        ...
        if (prod  == null && p.getDescricao().isBlank() == false && p.getEstoqueMinimo() >= 0 && p.getLucro() >=0 && p.getFornecedor().getNome() != null && p.getFornecedor().getNome().isBlank() ==false && p.getFornecedor().getCnpj() > 0){
